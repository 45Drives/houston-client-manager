...
EXCLUDE_PATTERN="dist **/*/dist build **/*/build builds node_modules **/*/node_modules"
...
# Create tarball excluding the specified directories
...
#rm "$LOCAL_OUTPUT_DIR/windows/*.blockmap"
...
"
mkdir $LOCAL_OUTPUT_DIR/mac/
/usr/bin/scp -r "$MAC_Host:$REMOTE_BUILD_DIR/dist/houston*" "$LOCAL_OUTPUT_DIR/mac/"
