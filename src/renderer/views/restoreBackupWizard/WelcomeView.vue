  ...
  <CardContainer>
    ...
    <div class="flex flex-col h-full justify-center items-center">
      ...
      <p class="w-9/12 text-left text-2xl">
        Your data matters—let’s bring it back safely. The restore wizard will help you recover files from your existing backups.
      </p>

      <br />

      <p class="w-9/12 text-left text-2xl">
        Whether you’re recovering a single document or an entire system backup, this wizard will guide you through selecting the files and restoring them to the correct location.
      </p>
