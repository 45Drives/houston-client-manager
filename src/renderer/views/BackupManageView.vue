<template>
    ...
    <div v-if="showWizard" class="fixed inset-0 z-[5] flex items-center justify-center bg-black/50">
        <div class="relative bg-well border border-default rounded-xl shadow-2xl w-[56rem] h-[48rem] max-w-[calc(100vw-3rem)] max-h-[calc(100vh-2rem)] flex flex-col overflow-hidden">
            <!-- Close button -->
