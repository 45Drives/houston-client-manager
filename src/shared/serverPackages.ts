...
export const HOUSTON_PACKAGES: readonly HoustonPackage[] = [
  { name: 'houston-broadcaster', label: 'Houston Broadcaster', minVersion: '2.5.0' },
  { name: 'cockpit-super-simple-setup', label: 'Super Simple Setup', minVersion: '1.3.3-2' },
  { name: 'cockpit-scheduler', label: 'Task Scheduler', minVersion: '1.9.2' },
