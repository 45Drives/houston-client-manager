...
45Drives Storage Wizard release script for building and publishing releases.
...
NOTES:
  ...
  - Releases are published to 45Drives/houston-client-manager
HELP
}
...
main() {
  ...
  echo "========================================="
  echo "  45Drives Storage Wizard Release"
  echo "========================================="
  ...
  # Set GitHub repo
  export GH_REPO="45Drives/houston-client-manager"
